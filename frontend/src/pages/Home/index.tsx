...
function HomeTabContent({ user }: { user: MockUser | null }): React.JSX.Element {
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', backgroundColor: '#f5f5f0' }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.75)', margin: '0 0 3px 0' }}>
          {getGreeting()},
        </p>
      ...
      <div style={{ padding: '20px 16px 88px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <button
          ...
          style={{
            ...
            boxShadow: '0 4px 20px rgba(26,147,111,0.3)',
            transition: 'transform 0.15s ease, box-shadow 0.15s ease',
          }}
          onMouseEnter={(e) => {
            const btn = e.currentTarget as HTMLButtonElement;
            btn.style.transform = 'translateY(-2px)';
            btn.style.boxShadow = '0 8px 28px rgba(26,147,111,0.35)';
          }}
          onMouseLeave={(e) => {
            const btn = e.currentTarget as HTMLButtonElement;
            btn.style.transform = 'translateY(0)';
            btn.style.boxShadow = '0 4px 20px rgba(26,147,111,0.3)';
          }}
        ...
        >
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)' }}>
              Take a photo to diagnose disease
            </div>
          </div>
        </button>
        ...
        {/* Recent Diagnoses */}
        <div>
          <h2 style={{ fontSize: '18px', fontWeight: 600, color: '#114b5f', margin: '0 0 12px 0' }}>
            Recent Diagnoses
          </h2>
          ...
          {MOCK_HISTORY.length === 0 ? (
            ...
            <div style={{
              ...
              padding: '40px 24px', border: '1.5px dashed #d1d5db',
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ fontSize: '14px', color: '#9ca3af', margin: 0 }}>
                  Tap <strong>Scan Crop</strong> to begin your first diagnosis
                </p>
              </div>
            </div>
          ) : (
            // Show last 2 diagnoses
        ...
        {crops.map((crop) => (
          <button
            ...
            style={{
              ...
              backgroundColor: activeFilter === crop ? '#1a936f' : '#ffffff',
...
function SettingsTabContent({ user }: { user: MockUser | null }): React.JSX.Element {
  const navigate = useNavigate();
    ...
    <div style={{ flex: 1, overflowY: 'auto', backgroundColor: '#f5f5f0' }}>
      ...
      <div style={{ padding: '20px 16px 88px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '11px', fontWeight: 700, color: '#9ca3af', margin: '0 0 14px 0', textTransform: 'uppercase', letterSpacing: '0.6px' }}>
            Account
          </p>
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div>
              <p style={{ fontSize: '17px', fontWeight: 600, color: '#1f2937', margin: 0 }}>
                {user?.name ?? '—'}
              </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <button
              ...
              style={{
                fontSize: '13px', fontWeight: 600, color: '#1a936f',
                background: 'none', border: 'none', cursor: 'pointer',
                padding: '4px 8px', borderRadius: '6px', minHeight: '36px',
              }}
            >
              Change
            </button>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '14px', fontWeight: 600, color: '#374151' }}>v0.1.0</span>
        </div>
        ...
        <button
          ...
          style={{
            ...
            border: '2px solid #c1121f', borderRadius: '8px',
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', backgroundColor: '#f5f5f0' }}>
      ...
      <aside
        style={{
          ...
          backgroundColor: '#ffffff', borderRight: '1.5px solid #e5e7eb',
          flexDirection: 'column', padding: '24px 0 0',
        }}
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {activeTab === 'home' && <HomeTabContent user={user} />}
